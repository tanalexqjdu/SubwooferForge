...
const contractABI = require("../artifacts/contracts/Subwooferforge.sol/Subwooferforge.json").abi;

program
    .name("subwooferforge-cli")
    .description("CLI tool for Subwooferforge smart contract")
    .version("1.0.0");
